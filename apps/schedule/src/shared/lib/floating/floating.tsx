...
export type FloatingProps<T extends ReferenceType> = Omit<FloatingFocusManagerProps, "context" | "children"> & {
    ...
    return (
        <FloatingNode id={ctx.context.nodeId}>
            <FloatingPortal>
                ...
                <FloatingFocusManager {...focusManagerProps} context={ctx.context} modal={ctx.modal}>
                    <Flex
                        direction="column"
