...
import { GridTable, type GridTableVariantsProps, type IGridTableProps } from "./grid-table";
...
export interface ITableRootProps
	extends Omit<IGridTableProps, "className" | "density" | "dividers" | "columnSizes">,
...
export const TableRoot = forwardRef<HTMLDivElement, ITableRootProps>(
	({ width, header, footer, appearance, density, className, columnSizes, ...gridProps }, ref) => {
