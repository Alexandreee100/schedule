...
const buildMiddlewarePipeline = (
    middleware: readonly Middleware[],
    baseFn: NextFn,
): NextFn =>
    middleware.reduceRight<NextFn>(
        (next, mw) => (config) => mw(config, next),
        baseFn,
    );
