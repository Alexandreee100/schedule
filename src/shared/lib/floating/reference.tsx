...
import type { SetReferenceType, WithFloatingContextHook } from "src/shared/lib/floating/types";

export type ReferenceProps<T extends ReferenceType> = {
    children: (props: Record<string, unknown> & { ref: SetReferenceType<T> }) => ReactElement;
